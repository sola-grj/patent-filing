...
function icon(type: PmNotificationItem["type"]) { if (type === "pm_signed_documents_received") return <FileSignature className="size-5" />; if (type === "pm_quote_confirmed" || type === "pm_quote_revision_approved") return <CircleCheck className="size-5" />; return <BellRing className="size-5" />; }
function tone(type: PmNotificationItem["type"]) { if (type === "pm_signed_documents_received") return "border-violet-200 bg-violet-50 text-violet-600"; if (type === "pm_quote_confirmed" || type === "pm_quote_revision_approved") return "border-emerald-200 bg-emerald-50 text-emerald-600"; if (type === "pm_quote_revision_rejected") return "border-red-200 bg-red-50 text-red-600"; return "border-sky-200 bg-sky-50 text-sky-600"; }
