...
begin
  ...
  if request_owner is null then
    ...
    ) returning translation_requests.request_no into v_request_no;
    ...
    returning request.request_no into v_request_no;
  ...
  return jsonb_build_object('request_no', v_request_no, 'request_file_ids', request_file_ids);
end;
$$;
